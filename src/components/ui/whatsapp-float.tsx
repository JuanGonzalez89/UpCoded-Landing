/**
 * Se mantiene el verde de marca de WhatsApp a proposito.
 * Es una senal de reconocimiento: pintado con el acento del sitio deja de leerse
 * como WhatsApp y pierde el click. Lo que si se adapta es la sombra, mucho mas
 * contenida que antes para no romper la regla de superficies planas.
 */
export function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-30 inline-flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_10px_24px_rgba(37,211,102,0.28)] transition-transform duration-200 ease-upcoded hover:scale-105 active:scale-[0.97] md:bottom-7 md:right-7"
      href={href}
      target="_blank"
